...
WINDOW_SIZE = 50        # 时间序列滑动窗口大小
BATCH_SIZE = 64         # 训练批次大小
EPOCHS = 20             # 训练轮数
LEARNING_RATE = 1e-3    # 学习率
HIDDEN_DIM = 64         # LSTM/RNN隐藏层维度
NUM_LAYERS = 2          # LSTM/RNN层数
DROPOUT_RATE = 0.0      # Dropout比例（正则化）
SAMPLE_RATIO = 0.5      # 数据采样比例
...
def main():
    ...
    train_dataset = pp.MBADataset(train_data, WINDOW_SIZE)
    test_dataset = pp.MBADataset(test_data, WINDOW_SIZE)
